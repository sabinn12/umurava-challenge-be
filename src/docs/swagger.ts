                ...
                schema: {
                  ...
                  items: {
                    ...
                    properties: {
                      ...
                      seniority: { type: "array", items: { type: "string" }, description: "Seniority of the challenge" },
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  ...
                  seniority: { type: "array", items: { type: "string", enum: ["Junior", "Mid", "Senior"] }, description: "Updated seniority of the challenge" },
                  skillsNeeded: { type: "array", items: { type: "string" }, description: "Updated skills needed for the challenge" },
